...
def plot_multiple_arrays(im_list, figure_title, labels):  # TODO: @motjuste please let plotting single graph work easy
    """
    ...
    max_col_size = len(im_list)  # TODO: @motjuste Gigiti
